    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="shadow-xl sm:rounded-2xl overflow-hidden" style="background:#f8faf5;">
                ...
                <div style="background: linear-gradient(135deg, #2d6a2d 0%, #4a9e3f 60%, #6abf5e 100%); padding: 2rem;">
                    <div class="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p style="color:white;font-weight:700;font-size:1.15rem;line-height:1.3;">{{ $user->name }}</p>
                            <p style="color:rgba(255,255,255,0.65);font-size:0.8rem;">{{ $user->email }}</p>
                        </div>
                ...
                {{-- Formulario --}}
                <form action="{{ route('admin.user.update', $user) }}" method="post" class="px-8 py-8">
                    @csrf
                    @method('PUT')
